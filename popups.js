...
BasisUI.isMobile = function () { return BasisUI.isOnTouchStart() || BasisUI.isPhone() || BasisUI.isiPad() || BasisUI.isAndroid(); }
...
BasisUrlPopup.prototype.buildLoading= function(){
     this.element["loading" ].innerHTML="<span><img src='images/loading.gif'></span><span>&nbsp;&nbsp;加载中...</span>";
...
BasisConfirmPopup.prototype.initContent= function(){
     ...
     this.element["tipDiv" ].setAttribute("class", "BasisConfirmContent");
     this.element["tipDiv" ].setAttribute("className", "BasisConfirmContent");
     ...
     this.element["innerButtonDiv" ].setAttribute("class", "BasisBtnsBox");
     this.element["innerButtonDiv" ].setAttribute("className", "BasisBtnsBox");
...
function BasisImagePopupWindow(imageUrl, width, title,showMask,className) {
    ...
    var loadingHtml = "<div class='loading-popups' style='padding:50px 0;'><span><img src='images/loading.gif'></span><span>&nbsp;&nbsp;加载中...</span></div>";
    ...
    $(".basis-popups").find("img.image-popup-content" ).load(function(){
        ...
        BasisImagePopupObj.size.width = newWidth;
